...
public class JanelaCadastrarProduto extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            Produto prod = new Produto(Integer.parseInt(jTextField3.getText()),jTextField1.getText(),Double.parseDouble(jTextField2.getText()));
            p.cadastrarProduto(prod);
        } catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaCadastrarProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaCadastrarProduto().setVisible(true);
            }
        });
    }
